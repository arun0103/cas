...
<div class="row ml-3" id="addNewEmployee">
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="nav-item  active"><a class="nav-link" href="#tab_1" data-toggle="tab" aria-expanded="true">Personal Info</a></li>
            <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab" aria-expanded="false">Official Info</a></li>
            <li class="nav-item"><a class="nav-link" href="#tab_3" data-toggle="tab" aria-expanded="false">Bank Info</a></li>
