    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group" >
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <select id="select_employee" class="form-control select2 percent100"  data-placeholder="Select an Employee" name="selectedEmployeeView">    
                        <option></option> 
                        </select>
                    </div>
                </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <div><label for="datepicker_punch_date" class="control-label">Punch Date</label></div>
...
@section('footer')
    ...
    $('#btn_search').click(function(){
        ...
        if(branch_id!="" && emp_id !="" && date !=""){
            ...
            if(branch_id ==""){
                $('#select_branch').siblings(".select2-container").addClass('error');
            }else{
                $('#select_branch').siblings(".select2-container").removeClass('error');
            }
            if(emp_id == ""){
                $('#select_employee').siblings(".select2-container").addClass('error');
            }else{
                $('#select_employee').siblings(".select2-container").removeClass('error');
            }
            if(date ==""){
                $('#datepicker_punch_date').addClass('error');
            }else{
                $('#datepicker_punch_date').removeClass('error');
            }
        }
    });
    ...
    function validateForm(formData){
       var valid = true;
        if(formData.shift_id == ""){
            $('#select_shift').addClass('error');
            valid = false;
        }else{
            $('#select_shift').removeClass('error');
        }
        if(formData.status == ""){
            $('#select_dayStatus').addClass('error');
            valid = false;
        }else{
            $('#select_dayStatus').removeClass('error');
        }
        ...
        if(formData.half_1_gate_pass == 1 && (formData.half_1_gp_out == "" || formData.half_1_gp_in == "" || formData.half_1_gp_hrs == "")){
            ...
            if(formData.half_1_gp_out == "")
                $('#gatePass1_out').addClass('error');
            else
                $('#gatePass1_out').removeClass("error");
            if(formData.half_1_gp_in == "")
                $('#gatePass1_in').addClass('error');
            else
                $('#gatePass1_in').removeClass("error");
            if(formData.half_1_gp_hrs == "")
                $('#inputHours1').addClass('error');
            else
                $('#inputHours1').removeClass("error");
        }else{
            $('#gatePass1_out').removeClass("error");
            $('#gatePass1_in').removeClass("error");
            $('#inputHours1').removeClass("error");
        ...
        if(formData.half_2_gate_pass == 1 && (formData.half_2_gp_out == "" || formData.half_2_gp_in == "" || formData.half_2_gp_hrs == "")){
            ...
            if(formData.half_2_gp_out == "")
                $('#gatePass2_out').addClass('error');
            else
                $('#gatePass2_out').removeClass('error');
            if(formData.half_2_gp_in == "")
                $('#gatePass2_in').addClass('error');
            else
                $('#gatePass2_in').removeClass('error');
            if(formData.half_2_gp_hrs == "")
                $('#inputHours2').addClass('error');
            else
                $('#inputHours2').removeClass('error');
        }else{
            $('#gatePass2_out').removeClass('error');
            $('#gatePass2_in').removeClass('error');  
            $('#inputHours2').removeClass('error');  
        ...
        if($('#datepicker_punch1_date').val()!=""){
            if($('#time_punch_1').val()!=""){
                $('#time_punch_1').removeClass('error');
                //alert("Validation 1 entered");
                punch_1 = makeDateTime($('#datepicker_punch1_date').val(),$('#time_punch_1').val() );
               // alert("Validate 1: "+punch_1);
            }else{
                $('#time_punch_1').addClass('error');
                valid = false;
            }
        }else{
            if($('#time_punch_1').val()!=""){
                $('#datepicker_punch1_date').addClass('error');
                valid = false;
            }else{
                $('#datepicker_punch1_date').removeClass('error');
            }
        }
        
        if($('#datepicker_punch2_date').val()!=""){
            if($('#time_punch_2').val()!=""){
                $('#time_punch_2').removeClass('error');
                ...
                $('#time_punch_2').addClass('error');
                valid = false;
            }
        }else{
            if($('#time_punch_2').val()!=""){
                $('#datepicker_punch2_date').addClass('error');
                valid = false;
            }else{
                $('#datepicker_punch2_date').removeClass('error');
            }
